 ...
 *       &lt;sequence&gt;
 *         &lt;element name="employment-category" type="{http://www.cienciavitae.pt/ns/employment-item}employment-category-ctype" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class EmploymentItems {
    ...
    public List<EmploymentCategoryCtype> getEmploymentCategory() {
        if (employmentCategory == null) {
            employmentCategory = new ArrayList<EmploymentCategoryCtype>();
        }
