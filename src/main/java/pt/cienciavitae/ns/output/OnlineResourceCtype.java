...
/**
 * Corresponding to "output:output-type[@code='P119']"
 * 
 * <p>Java class for online-resource-ctype complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="online-resource-ctype"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="title" type="{http://www.cienciavitae.pt/ns/common}string-400-stype"/&gt;
 *         &lt;element name="creation-date" type="{http://www.cienciavitae.pt/ns/common}date-ctype"/&gt;
...
@XmlType(name = "online-resource-ctype", propOrder = {
    "title",
    "creationDate",
    "url",
    "identifiers",
...
public class OnlineResourceCtype {

    @XmlElement(required = true)
    protected String title;
    @XmlElement(name = "creation-date", required = true)
    protected DateCtype creationDate;
     ...
     *     
     */
    public DateCtype getCreationDate() {
        return creationDate;
    }
     ...
     *     
     */
    public void setCreationDate(DateCtype value) {
