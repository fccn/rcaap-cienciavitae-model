...
/**
 * <p>Java class for institution-identifiers-ctype complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="institution-identifiers-ctype"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.cienciavitae.pt/ns/common}container-ctype"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="institution-identifier" type="{http://www.cienciavitae.pt/ns/common}institution-identifier-ctype" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "institution-identifiers-ctype", propOrder = {
    "institutionIdentifier"
})
public class InstitutionIdentifiersCtype
    extends ContainerCtype
{
    ...
    public List<InstitutionIdentifierCtype> getInstitutionIdentifier() {
        if (institutionIdentifier == null) {
            institutionIdentifier = new ArrayList<InstitutionIdentifierCtype>();
        }
